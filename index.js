...
const strivify = function(input){
    ...
    } else if (input.startsWith("Strive")){
        return input
...
if (result3 === 0 && result7 !== 0){
    ...
    console.log("The number is a multiple of 3 and 7")
} else {
    console.log("The number is neither a multiple of 3 nor 7")
}
